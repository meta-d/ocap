...
} from '@metad/components/datepicker'
...
@NgModule({
  ...
  exports: [NxTimeFilterEditorComponent, NxTodayFilterComponent, NxYearFilterComponent]
})
export class NxTimeFilterModule {}
