...
export const API_XPERT_AGENT = API_PREFIX + '/xpert-agent'
export const API_XPERT_AGENT_EXECUTION = API_PREFIX + '/xpert-agent-execution'
...
export const API_COPILOT = API_PREFIX + '/copilot'
export const API_CHAT = API_PREFIX + '/chat'
