...
import { createReactAgent, injectAgentFewShotTemplate } from 'apps/cloud/src/app/@core/copilot'
import { createCopilotAgentState } from 'apps/cloud/src/app/@core/copilot/types'
