...
export const createDefaultUsers = async (
	...
	defaultPeanutEmployeeUsers: IUser[];
	defaultCandidateUsers: IUser[];
}> => {
	const _defaultPeanutEmployeeUsers: Promise<IUser[]> = seedDefaultEmployeeUsers(
		connection,
		tenant,
		DEFAULT_PEANUT_EMPLOYEES
	);
