...
import { BusinessAreaUserDeleteCommand } from '../business-area-user.delete.command'
 ...
 */
@CommandHandler(BusinessAreaUserDeleteCommand)
export class BusinessAreaUserDeleteHandler implements ICommandHandler<BusinessAreaUserDeleteCommand> {
	constructor(
	...
	public async execute(command: BusinessAreaUserDeleteCommand): Promise<BusinessAreaUser | DeleteResult> {
		// const { input } = command;
